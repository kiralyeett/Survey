                ...
                <div class="card-body">
                   <form action="/questionnaires" method="post">
                       ...
                       <div class="form-group">
                           ...
                           <small id="titleHelp" class="form-text text-muted">Please add a title for the new Questionnaire.</small>
                           @error('title')
                       ...
                       <div class="form-group">
                           ...
                           <small id="purposeHelp" class="form-text text-muted">Please add a purpose for the new Questionnaire.</small>
                           @error('purpose')
                           <small class="text-danger">{{ $message }}</small>
                           @enderror
                       </div>
